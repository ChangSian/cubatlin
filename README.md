...
###  🎙️ Activities 👯
* DS with 3+ years experiences(LOMA ALMI certificated) in financial industry around forecasting(claim-repurchase model), optimization(Graph/DFS), prediction(cluster customer financial ranking).
